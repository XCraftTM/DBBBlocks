module.exports = {
    ...
    options: [
        {
            "id": "country",
            "name": "Country",
            "description": "Description: what Country do you live in?",
            "type": "TEXT"
        }
    ],
    ...
    async code(cache) {
      ...
      const response = await fetch(`http://api.weatherapi.com/v1/current.json?key=1c324a4789af4036b7a00204222112&q=${locationAwnser}&aqi=no`, {
	method: 'get',
    });
